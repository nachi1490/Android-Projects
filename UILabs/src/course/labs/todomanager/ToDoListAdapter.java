...
public class ToDoListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		View itemLayout = layout.inflate(R.layout.todo_item, parent, false);
		...
		statusView
				.setChecked(toDoItem.getStatus() == course.labs.todomanager.ToDoItem.Status.DONE);
		...
		statusView.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if (isChecked) {
					toDoItem.setStatus(course.labs.todomanager.ToDoItem.Status.DONE);
				} else
					toDoItem.setStatus(course.labs.todomanager.ToDoItem.Status.NOTDONE);
